...
#from coursedashboards.logger.logback import log_info, log_exception
from coursedashboards.dao import get_netid_of_current_user
from coursedashboards.dao.schedule import get_current_quarter_schedule
from coursedashboards.dao.pws import get_campus_of_current_user
from coursedashboards.dao.gws import is_grad_student, is_student,\
    ...
    is_staff_employee
from coursedashboards.dao.enrollment import get_main_campus
from coursedashboards.dao.exceptions import IndeterminateCampusException
...
request_cached_is_grad_student = _build_cache_method("grad_student",is_grad_student)


request_cached_is_undergrad = _build_cache_method("undergrad",is_undergrad_student)


request_cached_is_student = _build_cache_method("student",is_student)


request_cached_is_pce_student = _build_cache_method("pce_student",is_pce_student)

request_cached_is_student_employee = _build_cache_method("student_employee",is_student_employee)


request_cached_is_employee = _build_cache_method("student_employee",is_employee)


request_cached_is_faculty = _build_cache_method("faculty",is_faculty)
